...
<div class="content">
	<ScrollView id="projects">
		...
		<ProjectList title="{null}" projects="{filteredArchivedProjects}" showLastActive="{true}" showInfoIcons="{false}" {searchString} showIfNoProjects="{true}"> <!--  title="Archived Projects" -->
			{#if searchString}
